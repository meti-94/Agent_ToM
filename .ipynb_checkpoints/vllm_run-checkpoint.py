...
def load_vLLM_model(model_ckpt, device, seed, tensor_parallel_size=1):
    model2path = {
    ...
    # tokenizer2path = {
    #     'google/gemma-2-2b':'/home/unsw.mahdi/artifacts/llms/gemma-2-2b/',
    #     'google/gemma-2-9b':'/home/unsw.mahdi/artifacts/llms/gemma-2-9b/',
    # }
    
    tokenizer = AutoTokenizer.from_pretrained(model2path[model_ckpt], local_files_only=True)
    llm = LLM(
        model=model2path[model_ckpt],
        dtype="auto",
